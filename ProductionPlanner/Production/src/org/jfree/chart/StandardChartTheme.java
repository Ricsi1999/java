...
public class StandardChartTheme implements ChartTheme, Cloneable,
    ...
    public StandardChartTheme(String name, boolean shadow) {
        ...
        this.subtitlePaint = Color.WHITE;
        this.legendBackgroundPaint = new Color(70, 70, 70);
        this.legendItemPaint = Color.WHITE;
        this.chartBackgroundPaint = new Color(70, 70, 70);
        this.drawingSupplier = new DefaultDrawingSupplier();
        this.plotBackgroundPaint = new Color(100, 100, 100);
        this.plotOutlinePaint = Color.LIGHT_GRAY;
        this.labelLinkPaint = Color.WHITE;

...
public class Peasant extends Unit {
    ...
    /**
     * Tries to build a certain type of building. Can only build if there are
     * enough gold and wood for the building to be built.
     *
     * @param buildingType Type of the building
     * @return true, if the building process has started false, if there are
    ...
    /**
     * Start building a certain type of building. Keep in mind that a peasant
     * can only build one building at one time.
     *
     * @param buildingType Type of the building
     */
    ...
    /**
     * Determines if a peasant is free or not. This means that the peasant is
     * neither harvesting, nor building.
     *
